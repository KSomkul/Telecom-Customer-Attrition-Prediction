## Project: Telcom Customer Churn Prediction Project on R
## Author: Jill (Kornkanok) Somkul, Shashi Bala
...
# Omit missing values and Save to a new file "Telcom2"
Telcom2 <- Telcom[complete.cases(Telcom), ]
Telcom2 <- na.omit(Telcom)
table(is.na(Telcom2))
str(Telcom2)
# Note: the obs decrease from 7043 to 7032 (11 obs were deleted).
